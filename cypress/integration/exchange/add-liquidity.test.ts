describe('Add Liquidity', () => {
  ...
  it('loads the WBNB and tokens', () => {
    cy.visit('/add/0x40375C92d9FAf44d2f9db9Bd9ba41a3317a2404f/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82')
  ...
  it('redirects /add/WBNB to /add/WBNB/token', () => {
    ...
    cy.url().should(
      'contain',
      '/add/0x40375C92d9FAf44d2f9db9Bd9ba41a3317a2404f/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82',
    )
  })

  it('redirects /add/token-WBNB to /add/token/WBNB', () => {
    cy.visit('/add/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82-0x40375C92d9FAf44d2f9db9Bd9ba41a3317a2404f')
    cy.url().should(
      'contain',
      '/add/0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82/0x40375C92d9FAf44d2f9db9Bd9ba41a3317a2404f',
    )
  })
})
