...
const farm = farms.find((f) => f.lpSymbol === 'CAKE-BNB LP')

export const cakeBnbLpToken = new Token(ChainId.MAINNET, "0xC31E54c7a869B9FcBEcc14363CF510d1c41fa443", 18, 'CAKE-BNB LP')
