...
import { Constants } from './WolfConfig';
...
export const useWtBarnContract = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getWtBarnContract(library.getSigner()), [library])
}
export const useWtAnimalContract = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getWtAnimalContract(library.getSigner()), [library])
}
...
export const useHeroMintContract = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getHeroMintContract(library.getSigner()), [library])
}
...
export const useWarriorContract = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getWarriorContract(library.getSigner()), [library])
}

export const useWarriorMintContract = () => {
  const { library } = useActiveWeb3React()
  return useMemo(() => getWarriorMintContract(library.getSigner()), [library])
}
