...
import heroMintAbi from 'config/abi/raidHeroMint.json'
...
export const getWtAnimalContract = (signer?: Signer | Provider) => {
  return getContract(wtAnimalAbi, getWtAnimalAddress(), signer)
}
export const getWtBarnContract = (signer?: Signer | Provider) => {
  return getContract(wtBarnAbi, getWtBarnAddress(), signer)
}
export const getMarketplaceContract = (signer?: Signer | Provider) => {
  return getContract(marketplaceAbi, getMarketplaceAddress(), signer)
}
export const getHeroMintContract = (signer?: Signer | Provider) => {
  return getContract(heroMintAbi, getHeroMintAddress(), signer)
}
export const getHeroContract = (signer?: Signer | Provider) => {
  return getContract(heroAbi, getHeroAddress(), signer)
}
export const getWarriorContract = (signer?: Signer | Provider) => {
  return getContract(warriorAbi, getWarriorAddress(), signer)
}
export const getWarriorMintContract = (signer?: Signer | Provider) => {
  return getContract(warriorMintAbi, getWarriorMintAddress(), signer)
}