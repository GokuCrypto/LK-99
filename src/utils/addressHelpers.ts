...
export const getWtAnimalAddress = () => {
  return getAddress(addresses.wtAnimal)
}
export const getWtBarnAddress = () => {
  return getAddress(addresses.barn)
}
...
export const getHeroMintAddress = () => {
  return getAddress(addresses.heroMint)
}

export const getHeroAddress = () => {
  return getAddress(addresses.hero)
}

export const getWarriorAddress = () => {
  return getAddress(addresses.warrior)
}

export const getWarriorMintAddress = () => {
  return getAddress(addresses.warriorMint)
}

export const getBlackCardAddress = () => {
  return getAddress(addresses.blackCard)
}